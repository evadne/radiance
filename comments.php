...
<!-- You can start editing here. -->
	...
	<h3 id="trackbacks"><?php echo ping_count();?> Trackbacks/Pingbacks</h3>
	<ol class="trackbacks">
...
<p><?php _e('You must be',jounalist);?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php the_permalink(); ?>"><?php _e('logged in',journalist);?></a> <?php _e('to post a comment.',journalist);?></p>
<?php else : ?>
...
<p><?php _e('Logged in as',journalist);?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account',journalist); ?>"><?php _e('Logout &raquo;',journalist);?></a></p>
